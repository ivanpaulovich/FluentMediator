...
namespace FluentMediator
{
    public class CancellableAsync<Request, Response, Handler> : ICancellableAsync
    {
        ...
        public CancellableAsync(IMediator mediator, Func<Handler, Request, CancellationToken, Task<Response>> action)
        {
            _mediator = mediator;
        ...
        public async Task<Response1> SendAsync<Response1>(object request, CancellationToken cancellationToken)
        {
